<!-- source https://www.svgrepo.com/svg/354528/vue -->
<template>
<svg width="16px" height="16px" viewBox="0 -17.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
	<g>
